...
@*/
      ...
      //import Spinner from 'react-native-loading-loaded-overlay';
      ...
      super(props);
              ...
              arrDate:[],
                      ...
                      txtName:'',
                      txtAddress:'',
                      isTelemedicineEnable:'1',
                      txtAditionalInfo:'',
                      isTimeInvalidFromServer:false,
                      dataRadio: [
...
//  debugger;
        ...
        NetInfo.isConnected.fetch().done((isConnected) => {
                      ...
                      UserData.retriveData('isTelemedicineEnable').then((res) => {
                      //  debugger;
                        //console.log(res);
                        this.state({isTelemedicineEnable:res});
      ...
      */
      ...
      //  debugger;
        ...
        const { appointmentDateOne }  = this.state;
          ...
          if (SelectdAppointment === ''){
          alert("Please select a valid appointment type.");
                ...
                alert("Please enter the preferred provider name.");
                  ...
                  alert("Please enter the preferred provider phone number of 10 digit.");
                    ...
                    alert("Please enter the preferred provider address.");
                      ...
                      appointmentSchedule = {"timeZone": DeviceInfo.getTimezone(),"dates": arrDate.filter(String),"times": arrTime.filter(String)};
...
removeAdditionalDateTime = () =>{
 ...
 //console.log(this.state.arrDate);
  if (this.state.Array_Value_Index === 1){
