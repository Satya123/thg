    ...
    */
        ...
        componentDidMount() {
          AsyncStorage.getItem('editDetailsData')
              ...
              previousPaitent:value[0].patientName + "*",
                      ...
                      alert("Please Enter Preferred Provider Name");
                        ...
                        NetInfo.isConnected.fetch().done((isConnected) => {
                                 if (isConnected)
                                 {
                                     ...
                                     UserData.retriveData('token').then((resToken) => {
                                         UserData.retriveData('memberId').then((res) => {
                                             this.requestAppointment(resToken, res,SelectdAppointment,txtReasonData,appointmentSchedule,txtAditionalInfo,textProvider,txtName,txtPhone,txtAddress,this.state.SelectdPatient);
                                         });
                                     })
     ...
     <RNPickerSelect
        ...
        <View  style={styles.mainRow}>
           <View style={styles.viewContent} >
            ...
            <RNPickerSelect
                                placeholder={{
                                    label: this.state.previousPaitent,
