        ...
        this.state({isTelemedicineEnable:value});
                ...
                valuenew = 0
                        ...
                        previousAppointment:value[0].appointmentType.toString() + "*",
                                ...
                                previousName:value[0].patientName.toString() + "*",
                                previousPaitent:value[0].dependentID.toString(),
                                selectedAppointmentID:value[0].appointmentID,
                                txtName: value[0].providerName.toString(),
                                txtPhone: value[0].providerPhone.toString(),
                                txtAddress: value[0].providerAddress.toString(),
                                txtReasonData:value[0].visitReason.toString(),
                                appointmentDateOne:value[0].appointmentDate.toString(),
                                appointmentTimeOne:value[0].appointmentTime.toString(),
                                textProvider:value[0].providerOption.toString(),
                                txtAditionalInfo:value[0].schedulingNote.toString(),
