/*@ RequestAppointmentCard.js
 THG App
 This file use for show the request appontment details .
...
import React, { Component } from 'react';
        ...
        /*
         Api call for Insert  Appointment  Details.
         */
        ...
        var currentDate = new Date(dateSelected)
                ...
                var selctedDate = day + "/" + month + "/" + year
                return selctedDate;
        }
    ...
    clickToRequest = (strProvider) => {
       ...
       alert("my alert");
        ...
        /*
         @removeAdditionalDateTime: this function use for adding additional date and time text field for extra appontment.
         */
        ...
        /*
         @selcteAdditionalDateTime: this function use for adding additional date and time text field for extra appontment.
         */
        ...
        /*
         @multipuleDate: this function use to show by default date and time text field.
         */
...
<View style={styles.mainRow}>
    <View style={styles.viewContent} >
        <Text style={styles.textSub}>Appointment Times</Text>
    </View>
        ...
        <View style={styles.mainRowNew}>
            ...
            <DatePicker
                ...
                onPress = selectedRaidodata => this.setState({ selectedRaidodata });
                        /*
                         @selctedThirdProviderType: this function is call when user selcte Preferd Provider.
                         */

                        selctedThirdProviderType(){
                return(
<Animated.View style={[styles.containerKeybord, { paddingBottom: this.keyboardHeight }]}>
    <View style={styles.mainRow}>
        <View style={styles.viewContent} >
    ...
    <View style={styles.mainRow}>
        ...
        <View style={styles.viewText} >
            <TextInput
                ...
                /*
                 @clickToCannectTelimedcine: this function use to close the PrimaryCare Popup.
                 */
                clickToCancle = () => {
                this.setState({ isPrimary: true });
                        }
                ...
                /*
                 @clickToCannectTelimedcine: this function use to redirct you on Telemedicine page.
                 */
                ...
                /*
                 @primaryView: this function use to present Primary Care description.
                 */
...
<View style={styles.mainRow}>
    ...
    <View style={styles.viewText} >
        <Animated.View style={[styles.containerKeybordSecond, { paddingBottom: this.keyboardHeight }]}>
            <TextInput
                style={styles.textArea}
                underlineColorAndroid="transparent"
...
<View  style={styles.mainRow}>
    <View style={styles.viewContent} >
        <Text style={styles.textSub}>Is There Specific Provider</Text>
    </View>
    <View style={styles.viewText} >
